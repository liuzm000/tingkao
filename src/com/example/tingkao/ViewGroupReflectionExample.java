...
import com.example.tingkao.widget.fancycoverflow.FancyCoverFlow;
import com.example.tingkao.widget.fancycoverflow.FancyCoverFlowAdapter;
import com.squareup.picasso.Picasso;

public class ViewGroupReflectionExample extends BaseActivity {
    ...
    private  class ViewGroupExampleAdapter extends FancyCoverFlowAdapter {
        ...
        private int[] images = {R.drawable.hezixiansheng, R.drawable.hezixiansheng, R.drawable.hezixiansheng, R.drawable.hezixiansheng, R.drawable.hezixiansheng, R.drawable.hezixiansheng,};
        ...
        public View getCoverFlowItem(int i, View reuseableView, ViewGroup viewGroup) {
            ...
            Picasso.with(ctx).load(mImgIds[i]).into(customViewGroup.getImageView());
